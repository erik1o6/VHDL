...
va_list vap)
{
    extern HSim__s6 * createworkM_l_o_l(const char*);
    HSim__s6 *blk = createworkM_l_o_l(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","LOL", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkM_l_o_l(const char*);
        topvl = (HSim__s5*)createworkM_l_o_l("LOL");
