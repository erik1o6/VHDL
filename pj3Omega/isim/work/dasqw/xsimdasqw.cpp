...
va_list vap)
{
    extern HSim__s6 * createworkMdasqw(const char*);
    HSim__s6 *blk = createworkMdasqw(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","dasqw", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMdasqw(const char*);
        topvl = (HSim__s5*)createworkMdasqw("dasqw");
