...
va_list vap)
{
    extern HSim__s6 * createworkMcake(const char*);
    HSim__s6 *blk = createworkMcake(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","cake", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMcake(const char*);
        topvl = (HSim__s5*)createworkMcake("cake");
