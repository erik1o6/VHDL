...
va_list vap)
{
    extern HSim__s6 * createworkMlol123(const char*);
    HSim__s6 *blk = createworkMlol123(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","lol123", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMlol123(const char*);
        topvl = (HSim__s5*)createworkMlol123("lol123");
