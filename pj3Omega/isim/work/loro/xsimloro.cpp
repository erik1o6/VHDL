...
va_list vap)
{
    extern HSim__s6 * createworkMloro(const char*);
    HSim__s6 *blk = createworkMloro(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","loro", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMloro(const char*);
        topvl = (HSim__s5*)createworkMloro("loro");
