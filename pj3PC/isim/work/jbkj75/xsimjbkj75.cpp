...
va_list vap)
{
    extern HSim__s6 * createworkMjbkj75(const char*);
    HSim__s6 *blk = createworkMjbkj75(label); 
    return blk;
}
...
{
    extern HSim__s6* createWork_eapcf_behavioral(const char*);
    HSim__s6 *blk = createWork_eapcf_behavioral(label);
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","jbkj75", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("work","glbl", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("eapcf/behavioral", (HSimInstFactoryPtr)IF2, true);
        (*cfgvh).addVlogModule("eapcf", (HSimInstFactoryPtr)IF3, true);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMjbkj75(const char*);
        topvl = (HSim__s5*)createworkMjbkj75("jbkj75");
