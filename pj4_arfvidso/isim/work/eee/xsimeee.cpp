...
va_list vap)
{
    extern HSim__s6 * createworkMeee(const char*);
    HSim__s6 *blk = createworkMeee(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","eee", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMeee(const char*);
        topvl = (HSim__s5*)createworkMeee("eee");
