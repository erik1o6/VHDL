...
va_list vap)
{
    extern HSim__s6 * createworkMsilly(const char*);
    HSim__s6 *blk = createworkMsilly(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","silly", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMsilly(const char*);
        topvl = (HSim__s5*)createworkMsilly("silly");
