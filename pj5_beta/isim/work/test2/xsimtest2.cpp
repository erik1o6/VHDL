...
va_list vap)
{
    extern HSim__s6 * createworkMtest2(const char*);
    HSim__s6 *blk = createworkMtest2(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","test2", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMtest2(const char*);
        topvl = (HSim__s5*)createworkMtest2("test2");
